...
This document provides guidelines for internationalization of the Franc Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `franc_en.ts` remains unchanged.
