...
# TestP2PConn: A peer we use to send messages to francd, and store responses.
...
class CompactBlocksTest(FrancTestFramework):
    ...
    # This test actually causes francd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that francd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for francd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # francd will not send blocktxn responses for blocks whose height is
