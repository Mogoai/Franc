...
class BIP66Test(FrancTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # francd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and francd produces more specific reject
            # reasons.
