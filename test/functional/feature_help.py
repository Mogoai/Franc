...
"""Verify that starting franc with -h works as expected."""

from test_framework.test_framework import FrancTestFramework
from test_framework.util import assert_equal

class HelpTest(FrancTestFramework):
    ...
    def run_test(self):
        self.log.info("Start franc with -h for help text")
        ...
        self.log.info("Start franc with -version for version information")
        ...
        self.log.info("Start francd with -fakearg to make sure it does not start")
