...
class WalletTest(FrancTestFramework):
    ...
    def run_test(self):
        ...
        # Send 10 FRC with subtract fee from amount
        ...
        # Sendmany 10 FRC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/franc/franc/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
