...
class SegWitTest(FrancTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older francd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let francd fill it in.
