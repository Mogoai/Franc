...
public:
    ...
    void stepBy(int steps)
    {
        ...
        val = qMin(qMax(val, CAmount(0)), FrancUnits::maxMoney());
        setValue(val);
    }
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = fm.width(FrancUnits::format(FrancUnits::FRC, FrancUnits::maxMoney(), false, FrancUnits::separatorAlways));
...
#include <qt/francamountfield.moc>
